"""
the only difference between circular singly linked list :
-> in singly linked list last node points towards null
-> in circular singly linked list last node point towards first element
"""
